...
platforms.create(1750, 230, 'rock1');
...
function collectRuby (player, ruby)
{
   ...
   if (score === 125)
   {
      gameText = this.add.text(game.config.width / 10, game.config.height / 5, 'Congratulations! Mission Complete!', { fontSize: '30px', fill: '#0xff0000' });
      this.physics.pause();
   }
